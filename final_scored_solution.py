...
def main():
    '''
    This function is written to execute the whole program
    '''
...
if __name__ == "__main__":
    ...
    """)
    parser.add_argument("-solutions", help="(n+1)-clumns txt (tab separated) file (n+1 loci; where n = 0,1,..) containing solutions (a chosen gene per locus; set to example_solutions.txt by default)")
